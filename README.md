...
<html>
<head>
    <title>SLOT TIME TABLE - SUDHARSANAN (212224230276)</title>
    <style>
        table {
...
<body>
    ...
    <div class="center-text">
        <p><strong>SLOT TIME TABLE - SUDHARSANAN(212224230276) </strong></p>
    </div>
    <table>
        <tr>
...
<img width="1636" height="932" alt="image" src="https://github.com/user-attachments/assets/8bb39429-2eb3-4bf0-81a8-319a655cf142" />
